...
SECRET_KEY = 'an2!+w43cla$n(6p#^om)g=0#ar7--g0kijjh&72dj8n9saxgn'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'sampleproject/templates')], 
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'sampleproject/static'),
]
